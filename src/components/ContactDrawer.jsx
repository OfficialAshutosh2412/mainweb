              ...
              <div className="p-6 md:p-8 rounded-2xl glass-card border border-white/10 relative overflow-hidden shadow-xl">
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      type="submit"
                      className="btn-slide-blue w-full py-4 rounded-xl font-bold text-sm tracking-wide flex items-center justify-center gap-2 transition-all shadow-md active:scale-[0.99] cursor-pointer border border-ambient-blue/30"
                    >
